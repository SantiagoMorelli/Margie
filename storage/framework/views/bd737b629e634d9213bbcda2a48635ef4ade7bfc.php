                ...
                <div class="container">
                    ...
                    <?php if($sections->reasons->status == 1): ?>
                        ...
                        <div class="section-title mb20 headline text-cewhy-choose-us-sectionwhy-choose-us-sectionnter " style="text-align: center">
                            ...
                            <h2 style="text-align: center"><?php echo app('translator')->get('labels.frontend.layouts.partials.why_choose'); ?> <span><?php echo e(app_name()); ?>?</span></h2>
                        </div>
...
<?php echo $__env->make('frontend.layouts.app'.config('theme_layout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/margiesmagicalverbs.com/public_html/resources/views/frontend/index-1.blade.php ENDPATH**/ ?>