...
<?php $__env->startSection('content'); ?>
    ...
    <div class="update">
        <div class="text">
            ...
            <p style="
    font-weight: bold;
"> Learn real Spanish through my 12 Magical Verbs <br>
            ...
            <div class="container">
                <div class="section-title mb45 headline text-center ">
                    ...
                    <div class="cards ">
                        ...
                        <div class="card ">
                            <div class="image">
                                <img src="https://images.unsplash.com/photo-1566513783362-fd923a368d6b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80"
                                    alt="">

                            </div>
                            <div class="title">
                                <h3> Explore at your <br> own pace</h3>
                            </div>
                            <div class="text">
                        ...
                        <div class="card ">
                            <div class="title">
                                <h3> More choices <br> to learn</h3>
                            </div>
                            <div class="text">
                                <p> No subscritions!</p>
                ...
                <div class="section-title mb45 headline text-center ">
                    ...
                    <div class="reviews">
                        ...
                        <div class="comments">
                            ...
                            <div class="comment">
                                <div class="image">
                                    <img src="/images/review1.jpg" alt="" style="
    width: 774px;
...
<?php echo $__env->make('frontend.layouts.app' . config('theme_layout'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/santi/Documents/Intership/testing/resources/views/frontend/index-1.blade.php ENDPATH**/ ?>