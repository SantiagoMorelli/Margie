...
<head>
    ...
    <link
        href="<?php echo e(asset('/vendor/unisharp/laravel-ckeditor/plugins/codesnippet/lib/highlight/styles/monokai.css')); ?>"
        rel="stylesheet">
                                                ...
                                                <li class="menu-item-has-children ul-li-block">
                                                    ...
                                                    <ul class="sub-menu">
                                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view backend')): ?>
                                                            <li>
                                                                <a
                                                                    href="<?php echo e(route('admin.dashboard')); ?>"><?php echo app('translator')->get('navs.frontend.dashboard'); ?></a>
                                                            </li>
                                                        <?php endif; ?>

                                                        <li>
                                                            <a
                                                                href="<?php echo e(route('frontend.auth.logout')); ?>"><?php echo app('translator')->get('navs.general.logout'); ?></a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            <?php endif; ?>
...
<?php /**PATH /home/customer/www/margiesmagicalverbs.com/public_html/resources/views/frontend/layouts/app1.blade.php ENDPATH**/ ?>